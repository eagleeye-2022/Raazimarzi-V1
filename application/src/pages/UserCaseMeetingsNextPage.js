...
import React, { useState } from "react"; // ✅ removed useNavigate import - not used
          ...
          <div className="chat-section">
            <div className="chat-users">
              ...
              <div className="chat-user">
                <img
                  src={getAvatarUrl("Abhishek Singh")}
                  alt="Opponent"
                  onError={(e) => {
